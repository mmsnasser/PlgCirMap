...
ver{1} =[ 2.0+3.0i ; -2.0+3.0i ; -2.0+0.0i ;  1.0+0.0i ;  1.0-1.0i ; -2.0-1.0i ; ...
         -2.0-2.0i ;  2.0-2.0i ;  2.0+1.0i ; -1.0+1.0i ; -1.0+2.0i ;  2.0+2.0i];
% Choose alpha, an auxiliary point in the domain G
alpha =  -0.0+0.5i;
% alpha =  -1.1883 + 2.1897i;
%%
tic
