% compare_sc_example_simply_enlog_1.m
% Nasser, September 3, 2019
% In this code, we consider:
% bounded simply connected domain G inside elongated polygon with 4 vertices
% 
...
ver{1} = [ 6.0+1.0i ; -6.0+1.0i ; -6.0-1.0i ;  6.0-1.0i];
