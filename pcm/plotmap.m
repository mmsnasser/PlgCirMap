...
elseif nargin==3 & a=='v' & b=='plr'
    no1 = 16; % number of concentric circles to be plotted in the domain
    n_of_rd = 24; % number of radials to be plotted in the domain
...
elseif nargin==3 & a=='d' & b=='rec'
    no1 = 20; % number of horizontal lines to be plotted in the domain
